...
mutation_prob = 0.5        # mutation probability (tunning parameter)
generatoin_limit = 400
population_size = 15        # size of population (tunning parameter)
init_prob = 0.9            # Initialization probability (tunning parameter)
fitness_limit = 0           # not used anywhere
top_sol = 2                 # Top 2 solutions are kept while going to next gen
data = "280_10.txt"
...
def selection_pair(population):
    ...
    #x = [fitness(genome,Inputs) for genome in population]
